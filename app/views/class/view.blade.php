...
<ol class="breadcrumb">
<li><a href="#">Home</a></li>
<li class="active"><span>Manage Class</span></li>
</ol>
<div class="clearfix">
<h1 class="pull-left">All Class</h1>
<div class="pull-right top-page-ui">
<a href="" class="btn btn-primary pull-right">
<i class="fa fa-plus-circle fa-lg"></i> Add New Class
</a>
</div>
</div>
<div class="row">
...
@if($classes->count() > 0)   <?php $i=1; ?>     @foreach($classes as $classe)
